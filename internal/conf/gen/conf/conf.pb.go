...
const file_conf_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"conf.proto\x12\aexample\x1a\x1egoogle/protobuf/duration.proto\"4\n" +
	"\tBootstrap\x12'\n" +
	"\x06server\x18\x01 \x01(\v2\x0f.example.ServerR\x06server\"\xb2\x02\n" +
	"\x06Server\x12(\n" +
	"\x04grpc\x18\x01 \x01(\v2\x14.example.Server.GRPCR\x04grpc\x12(\n" +
	"\x04http\x18\x02 \x01(\v2\x14.example.Server.HTTPR\x04http\x1ai\n" +
	"\x04GRPC\x12\x18\n" +
	...
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x123\n" +
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\atimeoutB3Z1github.com/Dizzrt/ellie-layout/internal/conf;confb\x06proto3"
...
var file_conf_proto_goTypes = []any{
	(*Bootstrap)(nil),           // 0: example.Bootstrap
	(*Server)(nil),              // 1: example.Server
	(*Server_GRPC)(nil),         // 2: example.Server.GRPC
	(*Server_HTTP)(nil),         // 3: example.Server.HTTP
	(*durationpb.Duration)(nil), // 4: google.protobuf.Duration
}
var file_conf_proto_depIdxs = []int32{
	1, // 0: example.Bootstrap.server:type_name -> example.Server
	2, // 1: example.Server.grpc:type_name -> example.Server.GRPC
	3, // 2: example.Server.http:type_name -> example.Server.HTTP
	4, // 3: example.Server.GRPC.timeout:type_name -> google.protobuf.Duration
	4, // 4: example.Server.HTTP.timeout:type_name -> google.protobuf.Duration
